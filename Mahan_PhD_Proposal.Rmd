...
The first task is evaluate physical environmental conditions using a hydrodynamic model with sediment loading and transport as a proxy input for methylmercury concentrations. 
...
The third task is to apply the coupled modeled approach for sea-level rise scenarios. The goal of this assessment is to predict changes in the methlymercury concentrations and fish habitat as a result of sea-level rise.
