...
```{r echo=FALSE, fig.width=14, fig.height=10, fig.cap="Suitability index curves for Spawning Adult Alewife Habitat"}
...
According to Brown et al (2000), spawning adult alewives have a depth preference for MLT-10 meters. There is also a lower preference for habitat greater than 30 meters in depth (Pardue). 
...
#### Temperature
Brown et al (2000) describes a wide range of temperature preferences with optimal temperatures at 12-16 degrees celcius. The total range of temperatures suitable for spawning alewives is 8-20 degrees celcuis. Spawning success did not occur past 29.7 degrees (Pardue).

#### Flow Velocity
According to O'connell 1999, habitat patches with velocity values between .06 m/s and 0.16 m/s have a probability of 0.5 for the presence alewife eggs.

#### Sediment Composition
Spawning is extremely tlerant of suspended sediments (Pardue);(Auld and Schubel 1978).
#### Turbity 
