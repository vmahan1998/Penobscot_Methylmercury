---
title: "Spawning of American Shad"
author: "Vanessa Mahan"
date: "2023-04-01"
output: html_document
---
US FWS model:American Shad (Stier & Crance, 1985)

## Depth
Maximum suitability of habitat for juvenile American Shad was measured at 0-1.5 meters deep (Ross et al., 1997). 
```{r}
#depth_range <- c(0.305,0.61)#in meters
depth <- (0.5+1.2)/2 #average between min & max
depth_suitability_curve <- function(depth) {
  # Define the optimal range for depth
  optimal_depth_range <- c(0.5, 1.2) # meters

  # Define the lower and upper thresholds for depth
  lower_threshold <- 0.2 # meters
  upper_threshold <- 5 # meters
...
Temperture for spawning around 2-31 degrees celcius with optimal levels of 10-25 degrees celcius (Stier & Crance, 1985). 
```{r}
...
temperature_suitability_curve <- function(temperature,optimal_temp_range) {
  ...
  optimal_temp_range <- c(10,25) #celcius

  # Define the lower and upper thresholds for temperature
  lower_threshold <- 2 # psu
  upper_threshold <- 31 # psu
...
```
## Turbidity 
turbidity  of  0.75-2.25 nephelometric turbidityunits  (NTU) (Ross et al., 1997)